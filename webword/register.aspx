<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="webword.register" %>
<!DOCTYPE html>
        ...
        <div><div id="div_head">
           <h2 style="text-align:center;padding:10px;">Word 在线文档编辑器</h2></div>
            <div id="div_logic" style="width:50%;height:400px; margin:100px auto;border:1px solid silver;">
                <h3 style="text-align:center;padding:10px;border-bottom:1px solid silver;">注册</h3>
                <p style="text-align:center; margin-top:70px;">
                  ...
                  <p style="text-align:center;">
                    <span>密  码：</span><asp:TextBox ID="TextBox2" runat="server"  TextMode="Password"></asp:TextBox><br />
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="密码不能为空" ControlToValidate="TextBox2" CssClass="warn"></asp:RequiredFieldValidator></p>
                   <p style="text-align:center;">
                ...
                <p style="text-align:center;">
                    <asp:Button ID="Button1" runat="server" Text="注册" Height="21px" OnClick="Button1_Click"/></p>
            </div>
        </div>
    </form>
</body>
